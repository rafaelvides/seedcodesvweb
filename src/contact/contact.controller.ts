import {Controller, Body, Post, Get, Param, ParseIntPipe, Delete, Put} from '@nestjs/common'
...
export class contactController{
    ...
    @Put(':id')
    updateContact(@Param('id', ParseIntPipe)id: number, @Body() contact: updateContactDto){
